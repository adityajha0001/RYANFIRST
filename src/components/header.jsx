...
const Header =()=>{
    ...
    <div className="py-8 md:flex xl:flex justify-centrer 2xl:mx-64">
        ...
        <p className="text-xl text-gray-400 px-4 py-4 md:my-4 md:ml-4 xl:ml-8 2xl:mb-12 ">Create an impactful brand image by creating and publishing high-quality content, at speed and scale</p>
        <a href="/page" className="mx-4 my-4 md:ml-8 xl:ml-16 2xl:ml-20"><button className="bg-blue-800 text-white text-2xl font-bold rounded-full px-28 py-4">Get Started</button></a>
        </div>
