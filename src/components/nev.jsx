const Nev = () => {
  return (
    <>
      <nav className=" w-full mb-12 px-4 py-4 bg-white border-gray-200">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div
            className="hidden w-full my-4 h-auto md:block  md:w-auto"
            id="navbar-dropdown"
          >
            <ul className="flex flex-col p-4 mt-4 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:text-md md:border-0 ">
              <li>
                <a
                  href="#"
              ...
              <li>
                <button
                  ...
                  className="flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-700 rounded 
      hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto "
                ...
                <div
                  id="dropdownNavbar"
                  className=" hidden font-normal mx-12 bg-blue-600 divide-y divide-gray-100 rounded-lg shadow w-96 "
                >
                  <ul
